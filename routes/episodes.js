...
let episodes = [
  {
    ...
    thumbnail:
      "https://loremflickr.com/400/160/artificial-intelligence,technology",
    status: "published",
    views: 1250,
    downloads: 340,
  ...
  },
  {
    ...
    thumbnail: "https://loremflickr.com/400/160/investing,business",
    status: "scheduled",
    views: 0,
    downloads: 0,
  ...
  },
  {
    ...
    thumbnail: "https://loremflickr.com/400/160/meditation,relaxation",
    status: "published",
    views: 890,
    downloads: 220,
...
router.post("/", (req, res) => {
  ...
  const newEpisode = {
    ...
    thumbnail: thumbnail || "https://loremflickr.com/400/160/podcast,episode",
    status: status || "draft",
    views: 0,
    downloads: 0,
