...
let podcasts = [
  {
    ...
    coverImage: 'https://via.placeholder.com/400x160/000000/C1121F?text=Tech+Talk',
    episodes: 45,
    subscribers: 2340,
  ...
  },
  {
    ...
    coverImage: 'https://via.placeholder.com/400x160/000000/C1121F?text=Business+Insights',
    episodes: 28,
    subscribers: 1850,
  ...
  },
  {
    ...
    coverImage: 'https://via.placeholder.com/400x160/000000/C1121F?text=Health+Wellness',
    episodes: 32,
    subscribers: 2100,
  ...
  },
  {
    ...
    coverImage: 'https://via.placeholder.com/400x160/000000/C1121F?text=Music+Masters',
    episodes: 38,
    subscribers: 1900,
  ...
  },
  {
    ...
    coverImage: 'https://via.placeholder.com/400x160/000000/C1121F?text=Education+Now',
    episodes: 52,
    subscribers: 3100,
  ...
  },
  {
    ...
    coverImage: 'https://via.placeholder.com/400x160/000000/C1121F?text=Sports+Talk',
    episodes: 41,
    subscribers: 2700,
...
router.post('/', [
  ...
  const newPodcast = {
    ...
    category,
    host,
    coverImage: coverImage || 'https://via.placeholder.com/400x160/000000/C1121F?text=Podcast',
    episodes: 0,
    subscribers: 0,
